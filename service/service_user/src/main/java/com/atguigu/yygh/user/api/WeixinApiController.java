       ...
       // System.out.println("code = " + code);
        ...
        try {
            ...
            if(userInfo == null) { //数据库不存在微信信息
                ...
                String userresultInfo = HttpClientUtils.get(userInfoUrl);
                System.out.println("resultInfo:"+userresultInfo);
                JSONObject resultUserInfoJson = JSONObject.parseObject(userresultInfo);
                //解析用户信息
                //用户昵称
                String usernickname = resultUserInfoJson.getString("nickname");
                //用户头像
